...
@Config
@Autonomous(name = "REDAUROV2Gate")
public class REDAUROV24Gate extends DbzOpMode {
    ...
    public static double nearWallX = 127.573;
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path2 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(89.149, 84.168), new Pose(99.885, 54.734), new Pose(127.544, 59.850)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0)).build();

            Path3 = follower.pathBuilder().addPath(
                            new BezierCurve(new Pose(127.544, 59.850), new Pose(99.704, 54.734), new Pose(89.149, 84.168)))
                    .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0)).build();
